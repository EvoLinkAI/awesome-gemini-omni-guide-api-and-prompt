...
本倉庫中的大多數案例精選自 DeepMind 官方展示、提示詞指南以及社群實驗。
...
## 📰 最新消息
- **2026 年 5 月 25 日：** 新增 16 個社群案例 + 新增社群畫廊章節
...
- [✂️ 編輯](#️-編輯)
  - [🔄 元素替換](#-元素替換)
    - [案例 1：蝴蝶變蜜蜂](#案例-1蝴蝶變蜜蜂)
    - [案例 2：蜜蜂變螢火蟲](#案例-2蜜蜂變螢火蟲)
    - [案例 3-5：太空船與太空人系列](#案例-3-5太空船與太空人系列)
    - [案例 6：1896 年火車變形（作者 @emollick）](#案例-61896-年火車變形作者-emollick)
    - [案例 7：從影片中移除人物（作者 @arrakis_ai）](#案例-7從影片中移除人物作者-arrakis_ai)
    - [案例 8：隱形小提琴](#案例-8隱形小提琴)
    - [案例 9：運用世界知識更換地點（作者 @venturetwins）](#案例-9運用世界知識更換地點作者-venturetwins)
    - [案例 10：動畫轉真人實拍（作者 @arrakis_ai）](#案例-10動畫轉真人實拍作者-arrakis_ai)
  - [🎬 基礎場景](#-基礎場景)
    - [案例 1：小提琴手基礎鏡頭](#案例-1小提琴手基礎鏡頭)
  - [📷 鏡頭運動](#-鏡頭運動)
    - [案例 1：過肩角度](#案例-1過肩角度)
    - [案例 2：鏡頭從鞋子上搖到中景](#案例-2鏡頭從鞋子上搖到中景)
    - [案例 3：旅行自拍縮時攝影（作者 @ZaraIrahh）](#案例-3旅行自拍縮時攝影作者-zarairahh)
    - [案例 4：時尚無人機鏡頭（作者 @ariaxawan）](#案例-4時尚無人機鏡頭作者-ariaxawan)
    - [案例 5：俯視到 360 度旋轉（作者 @npaka123）](#案例-5俯視到-360-度旋轉作者-npaka123)
    - [案例 6：Omnizoom — 潛入照片（作者 @alexanderchen）](#案例-6omnizoom--潛入照片作者-alexanderchen)
  - [🎬 動作與同步](#-動作與同步)
    - [案例 1：動物玩具音效](#案例-1動物玩具音效)
    - [案例 2：公寓燈光同步](#案例-2公寓燈光同步)
    - [案例 3：彈珠連鎖反應](#案例-3彈珠連鎖反應)
    - [案例 4：建築燈光](#案例-4建築燈光)
    - [案例 5：拳擊對打寫實風格（作者 @RuzainaMeer）](#案例-5拳擊對打寫實風格作者-ruzainameer)
- [🎨 進階多模態](#-進階多模態)
  - [🪞 藝術風格](#-藝術風格)
    - [案例 1-3：鏡子系列](#案例-1-3鏡子系列)
    - [案例 4：動畫廣告一鏡到底（作者 @DenneyDara）](#案例-4動畫廣告一鏡到底作者-denneydara)
    - [案例 5：線條畫分離（作者 @alexanderchen）](#案例-5線條畫分離作者-alexanderchen)
  - [✨ 視覺特效](#-視覺特效)
    - [案例 1：手洞超級變焦](#案例-1手洞超級變焦)
    - [案例 2：滑板動態效果](#案例-2滑板動態效果)
    - [案例 3：AR HUD 疊加（作者 @jerrod_lew）](#案例-3ar-hud-疊加作者-jerrod_lew)
  - [🔗 跨模態](#-跨模態)
    - [案例 1：轉移到新環境](#案例-1轉移到新環境)
    - [案例 2：鳥群形狀搭配音訊](#案例-2鳥群形狀搭配音訊)
    - [案例 3：幻燈片轉動態（作者 @yoshifujidesign）](#案例-3幻燈片轉動態作者-yoshifujidesign)
    - [案例 4：料理擔當等距人物（搭配參照圖）（作者 @kumiko_shiraki）](#案例-4料理擔當等距人物搭配參照圖作者-kumiko_shiraki)
    - [案例 5：ChatGPT 指示書圖像作為輸入（作者 @Majin_AppSheet）](#案例-5chatgpt-指示書圖像作為輸入作者-majin_appsheet)
    - [案例 6：ChatGPT 插圖轉 Omni 動畫（作者 @mmmiyama_D）](#案例-6chatgpt-插圖轉-omni-動畫作者-mmmiyama_d)
  - [📋 分鏡](#-分鏡)
    - [案例 1：奢華化妝品廣告（作者 @aiwithaly）](#案例-1奢華化妝品廣告作者-aiwithaly)
    - [案例 2：讓我出現在這個故事中](#案例-2讓我出現在這個故事中)
    - [案例 3：3x3 分割畫面（作者 @alexanderchen）](#案例-33x3-分割畫面作者-alexanderchen)
    - [案例 4：不同角度動作回放（作者 @jerrod_lew）](#案例-4不同角度動作回放作者-jerrod_lew)
    - [案例 5：分割畫面影片（作者 @jerrod_lew）](#案例-5分割畫面影片作者-jerrod_lew)
  - [🔤 文字渲染](#-文字渲染)
    - [案例 1：字母物品序列](#案例-1字母物品序列)
    - [案例 2：逐字文字同步](#案例-2逐字文字同步)
    - [案例 3：文字渲染 AI 新聞（作者 @chrisfirst）](#案例-3文字渲染-ai-新聞作者-chrisfirst)
    - [案例 4：字型時裝秀（作者 @HBCoop_）](#案例-4字型時裝秀作者-hbcoop_)
- [⚖️ 比較](#️-比較)
  - [案例 1：Seedance 2.0 vs Gemini Omni Flash（作者 @JSFILMZ0412）](#案例-1seedance-20-vs-gemini-omni-flash作者-jsfilmz0412)
  - [案例 2：Gemini Omni vs Seedance 2.0 動作場景（作者 @CuriousRefuge）](#案例-2gemini-omni-vs-seedance-20-動作場景作者-curiousrefuge)
- [🧪 評估](#-評估)
  - [案例 1：Gemini Omni 品質評估（作者 @kenichiota0711）](#案例-1gemini-omni-品質評估作者-kenichiota0711)
- [🌐 社群畫廊](#-社群畫廊)
- [🙏 致謝](#-致謝)

## 🎯 提示詞要素
Gemini Omni 具有強大的**世界理解能力**——它能運用歷史、科學和文化方面的真實世界知識。你不需要過度描述每個細節，只需用自然語言表達你的創意意圖，讓 Omni 的推理能力來補充其餘部分。
從零開始建立新影片時，可以混合以下維度來控制輸出：
| 維度 | 需要指定的內容 | 範例 |
| :--- | :--- | :--- |
...
> [!TIP]
> **迭代編輯：** Omni 支援多輪對話編輯。它會保留有效的部分，只修改你要求變更的內容——無需每次重新描述整個場景。只需說明下一步要改什麼。

> [!TIP]
> **[保持畫面穩定](https://x.com/tanabe_fragm/status/2058103447006896406)（作者 [@tanabe_fragm](https://x.com/tanabe_fragm)）：** 編輯影片時，在 prompt 裡加上「不要改變其他部分」或「保持其他地方不變」等表述，可以顯著減少非指定區域被意外修改的情況。
>
...
#### 案例 6：[1896 年火車變形](https://x.com/emollick/status/2057874739817808223)（作者 [@emollick](https://x.com/emollick)） `🎬 Video→Video`
...
#### 案例 7：[從影片中移除人物](https://x.com/arrakis_ai/status/2057939231755178439)（作者 [@arrakis_ai](https://x.com/arrakis_ai)） `🎬 Video→Video`
...
#### 案例 9：[運用世界知識更換地點](https://x.com/venturetwins/status/2058235415883313361)（作者 [@venturetwins](https://x.com/venturetwins)） `🎬 Video→Video`
...
> 上傳 Waymo 乘車影片後，根據 Google Maps 截圖讓 Omni 在不同地點重新拍攝。模型運用其世界知識無縫切換環境。

---

#### 案例 10：[動畫轉真人實拍](https://x.com/arrakis_ai/status/2058488373057302797)（作者 [@arrakis_ai](https://x.com/arrakis_ai)） `🎬 Video→Video`
...
#### 案例 3：[旅行自拍縮時攝影](https://x.com/ZaraIrahh/status/2057775215749349520)(作者 [@ZaraIrahh](https://x.com/ZaraIrahh)) `🔤 Text→Video`
...
#### 案例 4：[時尚無人機鏡頭](https://x.com/ariaxawan/status/2057794715744084042)（作者 [@ariaxawan](https://x.com/ariaxawan)） `🔤 Text→Video`
...
#### 案例 5：[俯視到 360 度旋轉](https://x.com/npaka123/status/2058033145845575735)（作者 [@npaka123](https://x.com/npaka123)） `🖼️ Image→Video`
...
#### 案例 6：[Omnizoom — 潛入照片](https://x.com/alexanderchen/status/2058330610574221672)（作者 [@alexanderchen](https://x.com/alexanderchen)） `🖼️ Image→Video`
...
#### 案例 5：[拳擊對打寫實風格](https://x.com/RuzainaMeer/status/2057785474446741728)（作者 [@RuzainaMeer](https://x.com/RuzainaMeer)） `🔤 Text→Video`
...
#### 案例 4：[動畫廣告一鏡到底](https://x.com/DenneyDara/status/2057844409639551380)（作者 [@DenneyDara](https://x.com/DenneyDara)） `🔤 Text→Video`
...
#### 案例 5：[線條畫分離](https://x.com/alexanderchen/status/2057925025915666673)（作者 [@alexanderchen](https://x.com/alexanderchen)） `🎬 Video→Video`
...
#### 案例 3：[AR HUD 疊加](https://x.com/jerrod_lew/status/2058337271947079977)（作者 [@jerrod_lew](https://x.com/jerrod_lew)） `🎬 Video→Video`
...
#### 案例 3：[幻燈片轉動態](https://x.com/yoshifujidesign/status/2058032203175731293)（作者 [@yoshifujidesign](https://x.com/yoshifujidesign)） `🖼️ Image→Video`
...
#### 案例 4：[料理擔當等距人物（搭配參照圖）](https://x.com/kumiko_shiraki/status/2058337185099546885)（作者 [@kumiko_shiraki](https://x.com/kumiko_shiraki)） `🖼️ Image→Video`
...
> 技巧：當生成的影片與預期不符時，(1) 縮小參考圖範圍，(2) 增加 negative prompt 抑制不希望出現的元素。

---

#### 案例 5：[ChatGPT 指示書圖像作為輸入](https://x.com/Majin_AppSheet/status/2058191091070058846)（作者 [@Majin_AppSheet](https://x.com/Majin_AppSheet)） `🖼️ Image→Video`

<table>
<tr>
<td width="300">

**輸入（來自 ChatGPT 的指示書圖像）：**
...
> 工作流程：在 ChatGPT 中生成指示書／分鏡圖，然後直接餵給 Gemini Omni 作為視覺 prompt。

---

#### 案例 6：[ChatGPT 插圖轉 Omni 動畫](https://x.com/mmmiyama_D/status/2058654389326516656)（作者 [@mmmiyama_D](https://x.com/mmmiyama_D)） `🖼️ Image→Video`
...
> 工作流程：用 ChatGPT 圖像生成繪製示意圖 → 用 Gemini Omni 製作動畫。透過特定 prompt 可以抑制文字渲染崩壞的問題。

### 📋 分鏡

#### 案例 1：[奢華化妝品廣告](https://x.com/aiwithaly/status/2057806821138858314)（作者 [@aiwithaly](https://x.com/aiwithaly)） `🔤 Text→Video`
...
#### 案例 3：[3x3 分割畫面](https://x.com/alexanderchen/status/2057861567396368841)（作者 [@alexanderchen](https://x.com/alexanderchen)） `🎬 Video→Video`
...
#### 案例 4：[不同角度動作回放](https://x.com/jerrod_lew/status/2057838324140953773)（作者 [@jerrod_lew](https://x.com/jerrod_lew)） `🎬 Video→Video`
...
#### 案例 5：[分割畫面影片](https://x.com/jerrod_lew/status/2057944349846249975)（作者 [@jerrod_lew](https://x.com/jerrod_lew)） `🎬 Video→Video`
...
#### 案例 3：[文字渲染 AI 新聞](https://x.com/chrisfirst/status/2057863432469361098)（作者 [@chrisfirst](https://x.com/chrisfirst)） `🔤 Text→Video`
...
#### 案例 4：[字型時裝秀](https://x.com/HBCoop_/status/2057856570558452142)（作者 [@HBCoop_](https://x.com/HBCoop_)） `🔤 Text→Video`
...
#### 案例 2：[Gemini Omni vs Seedance 2.0 動作場景](https://x.com/CuriousRefuge/status/2057929340562907451)（作者 [@CuriousRefuge](https://x.com/CuriousRefuge)） `⚖️ Comparison`
...
#### 案例 1：[Gemini Omni 品質評估](https://x.com/kenichiota0711/status/2057820346850660769)（作者 [@kenichiota0711](https://x.com/kenichiota0711)） `🧪 Evaluation`
...
來自社群的創意實驗和展示，這些案例展現了 Gemini Omni 的能力廣度。

<table>
<tr>
<td width="50%" valign="top">

**[概念驅動的教學影片](https://x.com/VORTEX_Promos/status/2058083405204459621)** — 作者 [@VORTEX_Promos](https://x.com/VORTEX_Promos)
...
**[影片版 Nano Banana — 一致性測試](https://x.com/WolfRiccardo/status/2058296266270945483)** — 作者 [@WolfRiccardo](https://x.com/WolfRiccardo)
...
**[演講的等距角色](https://x.com/kumiko_shiraki/status/2058699566938194382)** — 作者 [@kumiko_shiraki](https://x.com/kumiko_shiraki)
...
**[一句話生成禪意影片](https://x.com/Dheepanratnam/status/2058372209681342806)** — 作者 [@Dheepanratnam](https://x.com/Dheepanratnam)
...
**[角色變換 — 從華麗到日常](https://x.com/HBCoop_/status/2058221428780970398)** — 作者 [@HBCoop_](https://x.com/HBCoop_)
...
感謝 Google DeepMind 發布的官方 Gemini Omni 展示和提示詞指南，使這些案例研究成為可能。
