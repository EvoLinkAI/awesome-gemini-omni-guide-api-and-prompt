...
**Caso 2: Transportar para Novo Ambiente** `🎬+🖼️ Video+Image→Video`
...
**Caso 3: Violino Invisível** `🎬 Video→Video`
...
**Caso 4: Ângulo por Cima do Ombro** `🎬 Video→Video`
...
**Caso 5: Inclinação da Câmera dos Sapatos ao Plano Médio** `🎬 Video→Video`
...
**Caso 6: Hyperlapse de Selfie de Viagem (por [@ZaraIrahh](https://x.com/ZaraIrahh))** `🔤 Text→Video`
...
**Caso 7: Tomada de Drone de Moda (por [@ariaxawan](https://x.com/ariaxawan))** `🔤 Text→Video`
...
**Caso 8: Tela Dividida 3x3 (por [@alexanderchen](https://x.com/alexanderchen))** `🎬 Video→Video`
...
**Caso 9: Replay de Ação de Diferentes Ângulos (por [@jerrod_lew](https://x.com/jerrod_lew))** `🎬 Video→Video`
...
**Caso 10: Vídeo em Tela Dividida (por [@jerrod_lew](https://x.com/jerrod_lew))** `🎬 Video→Video`
...
**Caso 11: Vista Superior para Rotação 360 (por [@npaka123](https://x.com/npaka123))** `🖼️ Image→Video`
...
**Caso 2: Som de Brinquedo Animal** `🎬 Video→Video`
...
**Caso 3: Sincronização de Luzes dos Apartamentos** `🎬+🎵 Video+Audio→Video`
...
**Caso 4: Reação em Cadeia com Bolinha de Gude** `🔤 Text→Video`
...
**Caso 5: Luzes do Edifício** `🎬+🎵 Video+Audio→Video`
...
**Caso 6: Efeitos de Movimento no Skate** `🎬 Video→Video`
...
**Caso 7: Luta de Boxe Realista (por [@RuzainaMeer](https://x.com/RuzainaMeer))** `🔤 Text→Video`
...
**Caso 1: Forma de Pássaros com Áudio** `🎬+🖼️+🎵 Multi-Modal`
...
**Caso 1: Me Mostre Nesta História** `🖼️ Image→Video`
...
**Caso 2: Comercial de Cosmético de Luxo (por [@aiwithaly](https://x.com/aiwithaly))** `🔤 Text→Video`
...
**Caso 3: Avaliação de Qualidade do Gemini Omni (por [@kenichiota0711](https://x.com/kenichiota0711))** `⚖️ Comparison`
