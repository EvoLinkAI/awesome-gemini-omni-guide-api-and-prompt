...
**案例 2：转移到新环境** `🎬+🖼️ Video+Image→Video`
...
**案例 6：旅行自拍延时摄影（作者 [@ZaraIrahh](https://x.com/ZaraIrahh)）** `🔤 Text→Video`
...
**案例 7：时尚无人机镜头（作者 [@ariaxawan](https://x.com/ariaxawan)）** `🔤 Text→Video`
...
**案例 8：3x3 分屏（作者 [@alexanderchen](https://x.com/alexanderchen)）** `🎬 Video→Video`
...
**案例 9：不同角度的动作回放（作者 [@jerrod_lew](https://x.com/jerrod_lew)）** `🎬 Video→Video`
...
**案例 10：分屏视频（作者 [@jerrod_lew](https://x.com/jerrod_lew)）** `🎬 Video→Video`
...
**案例 11：俯视图到360度旋转（作者 [@npaka123](https://x.com/npaka123)）** `🖼️ Image→Video`
...
**案例 7：拳击对战写实风格（作者 [@RuzainaMeer](https://x.com/RuzainaMeer)）** `🔤 Text→Video`
...
**案例 2：奢华化妆品广告（作者 [@aiwithaly](https://x.com/aiwithaly)）** `🔤 Text→Video`
...
**案例 3：Gemini Omni 质量评估（作者 [@kenichiota0711](https://x.com/kenichiota0711)）** `⚖️ Comparison`
